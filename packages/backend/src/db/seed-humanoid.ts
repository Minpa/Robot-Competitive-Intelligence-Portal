...
async function seedHumanoid() {
  ...
  for (const fname of fabricatedNames) {
    await db.delete(humanoidRobots).where(eq(humanoidRobots.name, fname));
  }
  console.log(`Removed unverified fabricated robots`);
  ...
  const robotsData = [
    ...
    // ── 2025-2026 확인된 신규 모델 ──────────────────────────────
    {
      ...
      commercializationStage: 'commercial',
      region: 'china',
      description: '휠-레그 듀얼 모드 휴머노이드. 데이터 수집 및 AI 학습용. Standard/Flagship 2종.',
      imageUrl: null,
      dataType: 'confirmed' as const,
    },
    {
      companyName: 'Figure AI',
      name: 'Figure 03',
      ...
      commercializationStage: 'pilot',
      region: 'north_america',
      description: 'Figure 02 후속. BotQ 공장 연 12,000대 생산 체제. 공장+가정 듀얼 배치 시작.',
      imageUrl: null,
      dataType: 'confirmed' as const,
    },
    {
      ...
      commercializationStage: 'commercial',
      region: 'china',
      description: '2025년 글로벌 출하량 1위(5,168대, 시장점유율 39%). CES 2026 Best of Innovation 수상.',
      imageUrl: null,
      dataType: 'confirmed' as const,
    },
    {
      ...
      commercializationStage: 'commercial',
      region: 'china',
      description: '산업용 양산 모델. 3분 자율 배터리 교체. 수주잔고 8억 위안(~$112M). 연 5,000대 생산 목표.',
      imageUrl: null,
      dataType: 'confirmed' as const,
    },
    {
      ...
      commercializationStage: 'pilot',
      region: 'korea',
      description: '삼성중공업 거제 조선소 파일럿 배치. 삼성전자 35% 지분 보유, 반도체/조선 공정 자동화.',
      imageUrl: null,
      dataType: 'confirmed' as const,
    },
    {
      ...
      commercializationStage: 'commercial',
      region: 'europe',
      description: '인지형 휴머노이드. Porsche 디자인. EUR 98,000. 수주잔고 EUR 10억. Mini 버전(EUR 19,999)도 출시.',
      imageUrl: null,
      dataType: 'confirmed' as const,
    },
    {
      ...
      commercializationStage: 'prototype',
      region: 'china',
      description: '풀사이즈 범용 휴머노이드. 중동 3년 수천 대 공급 계약 체결.',
      imageUrl: null,
      dataType: 'confirmed' as const,
    },
    // ── 2027 forecast 로봇 ──────────────────────────────────────
    {
      ...
      commercializationStage: 'commercial',
      region: 'north_america',
      description: 'Atlas Electric 상용 확대. Hyundai·Google DeepMind 외 추가 고객 온보딩.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: '2026 CES에서 CEO Robert Playter가 2027년 초 추가 고객 온보딩 계획 공식 발표.',
      forecastSources: 'CES 2026 Boston Dynamics 발표, IEEE Spectrum 보도',
    ...
    },
    {
      ...
      commercializationStage: 'commercial',
      region: 'europe',
      description: '세계 최초 소비자용 가정 휴머노이드. 168cm, 30kg. $20,000 또는 $499/월 구독.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: '2026 Q3-Q4 미국 조기 출시 후 2027년 글로벌 소비자 판매. 사전주문 진행 중.',
      forecastSources: '1X Technologies 공식 발표, TechCrunch 보도',
      forecastConfidence: 'high' as const,
    },
    {
      companyName: 'Apptronik',
      ...
      commercializationStage: 'commercial',
      region: 'north_america',
      description: 'Apollo 상용 대량 생산. Mercedes-Benz·GXO·Google DeepMind 배치. $80K/년 목표가.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: '2026년 $520M 투자(기업가치 $5B). Jabil 제조 파트너십. $1B 이상 수주 예상.',
      forecastSources: 'Apptronik Series B 발표, Bloomberg 보도',
      forecastConfidence: 'high' as const,
    },
    {
      companyName: 'Agibot',
      ...
      commercializationStage: 'commercial',
      region: 'china',
      description: '풀사이즈 범용 휴머노이드. 358 계획: 2027년 누적 100,000대, 매출 100억 위안 목표.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: 'A2 시리즈 대량 양산 성공(2026년 단일 모델 10,000대) 기반 풀사이즈 확장.',
      forecastSources: 'Agibot 358 계획 발표, Omdia 시장보고서',
    ...
    },
    {
      ...
      commercializationStage: 'pilot',
      region: 'china',
      description: 'Walker S2 후속. 연 10,000대 생산 확대. 자동차·물류·데이터센터 다분야 배치.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: 'Walker S2 양산(연 5,000대) 성공 후 차세대 모델 및 생산 확대 예상.',
      forecastSources: 'UBTECH 생산 로드맵, 중국 산업 보도',
      forecastConfidence: 'medium' as const,
    },
    {
      companyName: 'Hyundai Motor Group',
      name: 'HMG Shipyard Robot',
      announcementYear: 2027, announcementQuarter: 3,
      status: 'development',
      purpose: 'industrial',
      locomotionType: 'bipedal',
      handType: 'multi_finger',
      commercializationStage: 'pilot',
      region: 'korea',
      description: 'HD현대·Persona AI·Vazil 공동 개발 조선소 용접용 휴머노이드.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: '2025년 말 기능 프로토타입 완성 후 2027년 상업 배치 계획 발표.',
      forecastSources: 'HD현대-Persona AI 파트너십 발표',
      forecastConfidence: 'medium' as const,
    },
    {
      companyName: 'Figure AI',
      ...
      commercializationStage: 'commercial',
      region: 'north_america',
      description: 'Figure 03 양산 확대형. BotQ 공장 100,000대/년 목표. 로봇이 로봇을 생산하는 라인 구축.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: 'BotQ 12,000대/년 → 100,000대/년 확장 로드맵. 기업가치 $39B.',
      forecastSources: 'Figure AI 로드맵, WSJ 보도',
      forecastConfidence: 'medium' as const,
    },
    {
      companyName: 'Kepler Robot',
      ...
      commercializationStage: 'commercial',
      region: 'china',
      description: 'Forerunner K2 대량 배치. SAIC-GM 실증 완료 후 양산. $20,000-$30,000 가격대.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: '2025년 SAIC-GM 상하이 공장 실증 진행. 수천 대 사전주문 확보.',
      forecastSources: 'Kepler Robotics 발표, SAIC-GM 파일럿 보도',
      forecastConfidence: 'medium' as const,
    },
    // ── 2028 forecast 로봇 ──────────────────────────────────────
    {
      companyName: 'Boston Dynamics',
      name: 'Atlas Factory',
      announcementYear: 2028, announcementQuarter: 2,
      status: 'commercial',
      purpose: 'industrial',
      locomotionType: 'bipedal',
      handType: 'multi_finger',
      commercializationStage: 'commercial',
      region: 'north_america',
      description: '현대자동차 전용 로봇 공장에서 연 30,000대 생산. 자동차 부품 시퀀싱·조립 통합.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: '현대자동차 RMAC 파일럿 성공 기반. 전용 로봇 공장 30,000대/년 생산 계획.',
      forecastSources: 'Hyundai-BD 생산 로드맵 발표',
      forecastConfidence: 'medium' as const,
    },
    {
      companyName: 'Samsung Electronics',
      name: 'Samsung Humanoid',
      announcementYear: 2028, announcementQuarter: 1,
      status: 'development',
      purpose: 'industrial',
      locomotionType: 'bipedal',
      handType: 'multi_finger',
      commercializationStage: 'pilot',
      region: 'korea',
      description: 'Rainbow Robotics 협력 지능형 휴머노이드. CEO 직속 Future Robotics Office 주도.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: 'Rainbow Robotics 35% 지분 보유. K-Humanoid Alliance 참여. 2028년 상용화 목표.',
      forecastSources: 'Samsung-Rainbow Robotics 파트너십, K-Humanoid Alliance 발표',
      forecastConfidence: 'medium' as const,
    },
    {
      companyName: 'Doosan Robotics',
      name: 'Doosan Humanoid',
      announcementYear: 2028, announcementQuarter: 2,
      status: 'development',
      purpose: 'industrial',
      locomotionType: 'bipedal',
      ...
      commercializationStage: 'prototype',
      region: 'korea',
      description: 'NVIDIA 파트너십 기반 Agentic OS 탑재 산업용 휴머노이드.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: '2027년 인텔리전트 로봇 솔루션 공개 후 2028년 산업용 휴머노이드 출시 계획.',
      forecastSources: 'Doosan-NVIDIA 파트너십 발표',
      forecastConfidence: 'medium' as const,
    },
    {
      companyName: 'Tesla',
      ...
      commercializationStage: 'pilot',
      region: 'north_america',
      description: 'Optimus 4세대. Giga Texas 대량 생산. 기업 고객 본격 판매.',
      imageUrl: null,
      dataType: 'forecast' as const,
      forecastRationale: 'Gen 3 2026년 하반기 생산 시작 후 차세대 모델 예상. 단, Tesla는 2022년 이후 모든 Optimus 일정 지연 이력 있음.',
      forecastSources: 'Tesla AI Day 로드맵, Electrek 보도',
      forecastConfidence: 'low' as const,
    },
  ];
