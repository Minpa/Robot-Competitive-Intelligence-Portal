...
const SCORING_RUBRIC: Record<string, { levels: string[]; perfectSpec: string }> = {
  physical: {
    levels: [
      '15 DOF 미만. 가반하중 3kg 이하. 실내 평지만 이동. 배터리 1시간 미만. 하드웨어 프로토타입 수준.',
      '15-25 DOF. 가반하중 5-10kg. 실내 이동 가능, 계단 불가. 2-3시간 동작. 기본 액추에이터.',
      '25-35 DOF. 가반하중 10-20kg. 계단/경사 대응. 4-5시간 연속. 기본 방진. 4-5km/h 보행.',
      '35-50 DOF. 가반하중 20-35kg. 6km/h+. IP54 방수방진. 다양한 지형 대응. 고성능 액추에이터.',
      '50+ DOF. 가반하중 50kg+. IP67. 극한 환경(-20~40°C). 8km/h+. 파쿠르/점프 가능. 8시간+ 연속.',
    ],
    perfectSpec: 'Atlas급 56-DOF 전신 관절. 50kg 가반하중. IP67 완전 방수방진. -20~40°C 극한 환경. 8km/h 이상 보행속도. 파쿠르·점프·회전 등 극한 동작. 8시간+ 연속 가동. 커스텀 고토크 전기 액추에이터.',
  },
  perception: {
    levels: [
  ...
  dexterity: {
    levels: [
      '고정 그리퍼 또는 단순 집게. 2-3 DOF. 단일 크기 물체만 파지. 촉각 센서 없음.',
      '4-6 DOF 그리퍼. 픽앤플레이스 가능. 무거운 물체 제한. 기본 힘 제어. 도구 사용 불가.',
      '8-12 DOF 다관절 핸드. 다양한 크기·형상 파지. 기본 촉각. 간단한 도구 사용 가능.',
      '16+ DOF 5핑거 핸드. 섬세한 촉각 센서. 달걀·유리컵 등 정밀 파지. 복잡 도구 조작 가능.',
      '22+ DOF/손. 3g 수준 초정밀 촉각. 인간 수준 손재주. 모든 도구·악기·정밀 기구 자유자재.',
    ],
    perfectSpec: '22+ DOF 양손 5핑거. 3g 수준 초정밀 촉각 센서. 손가락 독립 제어. 힘/토크 피드백. 인간 수준 손재주로 바늘꿰기·악기 연주·정밀 조립 가능. 모든 공구·가정용 도구 자유자재 사용.',
  },
  interaction: {
    levels: [
