  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-slate-400 text-sm">벤치마크 데이터 로딩 중...</div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        {data.competitors.map(comp => {
          const color = COMPANY_COLORS[comp.slug] || 'rgb(var(--color-slate-400))';
          ...
          return (
            <button
              ...
              style={{
                ...
                color: isActive ? color : 'rgb(var(--color-slate-500))',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        {/* Radar Chart (3 cols) */}
        <div className="lg:col-span-3 bg-slate-800/50 rounded-xl border border-slate-700 p-4 flex items-center justify-center">
          <BenchmarkRadarChart
            axes={data.axes}
