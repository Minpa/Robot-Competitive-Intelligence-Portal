  ...
  if (isLoading) {
    return (
      <div className={`bg-gradient-to-br ${colorClasses[color]} border rounded-xl p-4 animate-pulse`}>
        <div className="h-4 bg-ink-100 rounded w-2/3 mb-3" />
        <div className="h-8 bg-ink-100 rounded w-1/2 mb-2" />
        ...
        <div className="flex items-center gap-1 text-xs">
          {delta > 0 ? (
            <>
              ...
              <span className="text-ink-500">전주 대비</span>
            ...
            <>
              <span className="text-ink-500 flex items-center">
                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
