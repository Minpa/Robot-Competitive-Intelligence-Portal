...
export function DemoBanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-900/40 via-paper/60 to-cyan-900/40 border-b border-blue-500/20">
      <div className="max-w-7xl mx-auto px-4 py-2">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="p-1 rounded text-ink-500 hover:text-ink-700 hover:bg-ink-100 transition-colors flex-shrink-0"
            title="데모 모드 닫기"
          >
