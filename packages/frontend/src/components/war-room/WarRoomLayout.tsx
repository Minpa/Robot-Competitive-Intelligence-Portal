    ...
    <div className="min-h-screen bg-paper">
      <div className="max-w-[1600px] mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-ink-900">전략 워룸</h1>
        ...
        {/* Tab Navigation */}
        <nav className="mb-6 flex gap-1 overflow-x-auto border-b border-ink-200 pb-px" aria-label="전략 워룸 탭">
          {tabs.map((tab) => {
            const isActive =
              tab.href === '/war-room'
                ? pathname === '/war-room'
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'border-b-2 border-blue-500 bg-white text-blue-400'
