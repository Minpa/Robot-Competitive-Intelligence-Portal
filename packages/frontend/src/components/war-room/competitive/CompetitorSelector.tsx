      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-md border border-slate-700 px-2 py-1 text-xs text-slate-300 hover:bg-slate-800 transition-colors"
          >
            Top 5
          </button>
          <button
          ...
          <button
            ...
            className="rounded-md p-1 text-slate-400 hover:bg-slate-800 transition-colors"
          >
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="truncate text-xs font-medium text-white">{c.robotName}</p>
                  <p className="truncate text-[10px] text-slate-500">{c.companyName}</p>
                </div>
                <span className="ml-auto flex-shrink-0 text-[10px] text-slate-600">#{i + 1}</span>
              </button>
            );
          })}
        </div>
