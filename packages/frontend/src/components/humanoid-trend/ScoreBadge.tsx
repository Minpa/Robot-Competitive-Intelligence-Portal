    ...
    <div className="inline-flex items-center gap-1.5 text-xs">
      ...
      {hasEstimated && (
        ...
        >
          ...
          {showTooltip && (
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 z-50 w-48 px-2.5 py-2 rounded-lg bg-white text-ink-900 text-[11px] leading-relaxed shadow-lg">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-ink-200" />
            </div>
          )}
        </div>
      )}
