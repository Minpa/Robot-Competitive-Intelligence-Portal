          ...
          <Panel padding="none">
            ...
            <div className="flex items-start justify-between gap-4 px-5 py-4">
              <div className="min-w-0">
                <h2 className="text-[15px] font-semibold text-ink-900 leading-snug">{playingCurrent.title}</h2>
              ...
              {videos.map((v) => (
                ...
                >
                  ...
                  <div className="px-2.5 py-2">
                    <h3 className="text-[12px] font-semibold text-ink-900 leading-snug line-clamp-2">{v.title}</h3>
                        ...
                        {items.map((v) => {
                          ...
                          return (
                            <tr key={v.id} className="border-t border-ink-100">
                              ...
                              <td className="py-2 pr-3">
                                <p className="text-[12px] text-ink-900">{v.title}</p>
