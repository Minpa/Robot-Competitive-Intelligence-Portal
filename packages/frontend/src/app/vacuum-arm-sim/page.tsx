...
export default function VacuumArmSimPage() {
    ...
    <div className="-m-8 flex flex-col bg-[#0a0a0a]">
      <div className="flex items-center justify-between px-6 py-3 bg-[#0f0f0f] border-b border-white/10">
        <div className="flex flex-col">
          <span className="font-mono text-[9px] font-medium uppercase tracking-[0.22em] text-[#00D9FF]">
            Prototype · v0.1 · Spec → Risk Playground
          </span>
          <span className="text-[13px] font-medium text-white mt-0.5">
            Vacuum + Arm Feasibility Simulator
          </span>
        </div>
        <div className="flex items-center gap-2">
          <a
            href="/prototypes/vacuum-arm-feasibility.html"
            target="_blank"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-mono uppercase tracking-[0.14em] text-[#0a0a0a] bg-[#00D9FF] hover:bg-[#33e0ff] transition-colors"
          >
      ...
      <iframe
        src="/prototypes/vacuum-arm-feasibility.html"
        title="Vacuum + Arm Feasibility Simulator"
