    ...
    <div className="grid grid-cols-12 gap-4">
      ...
      <div className="col-span-12 space-y-4 lg:col-span-8">
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900 p-4">
          <h3 className="mb-3 text-sm font-semibold text-white">필터</h3>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <div>
              <label className="mb-1 block text-xs text-slate-400">로봇 선택</label>
              <RobotMultiSelect
                robots={lgRobots}
            ...
            <div>
              <label className="mb-1 block text-xs text-slate-400">팩터 선택</label>
              <FactorMultiSelect
