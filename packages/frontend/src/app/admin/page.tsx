                  ...
                  <div key={s.provider} className="bg-paper border border-ink-200 rounded-xl p-5">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-semibold text-ink-900">
                        {s.provider === 'chatgpt' ? 'OpenAI (ChatGPT)' : s.provider === 'gemini' ? 'Google (Gemini)' : 'Anthropic (Claude)'}
                      </h3>
                    </div>
                      ...
                      <div key={log.id} className="px-4 py-2 grid grid-cols-12 gap-2 text-sm border-t border-ink-200 hover:bg-paper">
                        <div className="col-span-2">
                          <span className={`px-2 py-0.5 rounded text-xs ${
                            log.provider === 'chatgpt' ? 'bg-green-500/20 text-green-400' : log.provider === 'gemini' ? 'bg-blue-500/20 text-blue-400' : 'bg-orange-500/20 text-orange-400'
                          }`}>
                            {log.provider === 'chatgpt' ? 'OpenAI' : log.provider === 'gemini' ? 'Gemini' : 'Claude'}
                          </span>
                        </div>
