        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center gap-2 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-lg px-4 py-2">
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
                <span className="text-xs font-medium text-blue-300">Live</span>
                <span className="text-xs text-slate-500">|</span>
                <span className="text-xs text-slate-400">38+ Robots</span>
                <span className="text-xs text-slate-500">|</span>
                <span className="text-xs text-slate-400">24 Companies</span>
              </div>
            </div>
          </div>
