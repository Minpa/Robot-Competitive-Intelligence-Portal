...
function LgeProcessesContent() {
  ...
  // BCG 동작군 — 이 라인에 실제 등장하는 그룹만 (count > 0) 노출
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-[13.5px] text-[#5F5E5A] leading-relaxed max-w-[980px]">
            ...
            (2) 필요 EE (그리퍼 / 핸드 / 도구), (3) <strong>BCG 6 동작군</strong> + RFM 속성 태그(강체·유연체·하중·정위치·결선방식),
            (4) 하네스 체결 결선 난이도 sub-task로 분류. 매트릭스 ⑤ 나사 / ⑥ 커넥터 / ⑦ 케이블 셀과 연결.
          </p>
          <p className="font-mono text-[10.5px] text-[#A0764A] mt-2">
            ⚠️ BCG 동작군·RFM 태그·하네스 sub-type 은 BCG 슬라이드 + 공정 작업내용 기반 1차 매핑(추정). BCG 원본 표 입수 시 정밀 보정 예정.
          </p>
        </div>
        ...
        <div className="bg-white border border-[#E8E6DD] p-4 mb-4" style={{ borderRadius: 8 }}>
          <p className="font-mono text-[10.5px] text-[#888780] uppercase tracking-[0.14em] mb-2.5">
            BCG 6 동작군 분포 — 이 라인은 조립·체결·결선 중심 (Pick&amp;Place·용접 미등장)
          </p>
        ...
        <div className="bg-white border border-[#C8366E]/40 p-4 mb-4" style={{ borderRadius: 8 }}>
          <p className="font-mono text-[10.5px] text-[#7A0F2C] uppercase tracking-[0.14em] mb-2.5">
            하네스 체결 세분화 (BCG ⑦) — 결선 난이도 오름차순 · 총 {harnessTotal}공정
          </p>
        ...
        <div className="flex items-center gap-3 flex-wrap mb-3">
          <span className="font-mono text-[10.5px] text-[#888780] uppercase tracking-[0.14em]">BCG 동작군:</span>
          <button
          ...
          <table className="w-full text-[13px] border-collapse">
            <thead>
              <tr className="bg-[#FAFAF7]">
                ...
                <th className="text-left p-2.5 border-b border-[#E8E6DD] font-mono text-[10px] uppercase tracking-[0.14em] text-[#5F5E5A] w-44">BCG 동작군</th>
        ...
        <p className="font-mono text-[10.5px] text-[#888780] mt-4 leading-relaxed">
          ...
          BCG 동작군 컬럼의 하네스 공정은 결선 난이도 sub-task를 함께 표기.
        </p>
      </div>
    </div>
  );
